...
with open('snake.min.js') as f:
    js = f.read()

# 2. Минифицируем CSS
print("🎨 Минификация CSS...")
with open('snake.css') as f:
    css = f.read()
...
os.remove('snake.min.js')

# Считаем размеры
original_size = os.path.getsize('index.html') + os.path.getsize('snake.css') + os.path.getsize('snake.js')
